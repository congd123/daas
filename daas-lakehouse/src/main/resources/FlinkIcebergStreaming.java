...
public class FlinkIcebergStreaming {
    private static final Logger LOGGER = LoggerFactory.getLogger(FlinkIcebergStreaming.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        FlinkSink.forRow(streamRow, FlinkSchemaUtil.toSchema(schema))
                .tableLoader(TableLoader.fromCatalog(catalogHiveLoader, outputTable))
                .toBranch(parameters.get("branch", "main"))
                .distributionMode(DistributionMode.HASH)
                .writeParallelism(1)
                .upsert(true)
                .equalityFieldColumns(List.of("date","name"))
                        .append();
